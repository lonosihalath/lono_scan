...
//
//public class lono_scanView extends SurfaceView implements SurfaceHolder.Callback, Camera.PreviewCallback,
...
//    private String LOG_TAG = "lono_scan";
...
//    public lono_scanView(Context context, Activity activity, @NonNull ActivityPluginBinding activityPluginBinding, @Nullable Map<String, Object> args) {
//        super(context, null);
//
...
//        private final WeakReference<lono_scanView> viewRef;
//        private final WeakReference<Map<DecodeHintType, Object>> hintsRef;
//
//        DecodeFrameTask(lono_scanView view, Map<DecodeHintType, Object> hints) {
...
//            final lono_scanView lono_scanView = viewRef.get();
//            if (lono_scanView == null) return null;
//            Result result = null;
//
//            final PlanarYUVLuminanceSource source = lono_scanView.cameraManager.buildLuminanceSource(
//                    params[0],
//                    (int) lono_scanView.previewWidth,
//                    (int) lono_scanView.previewHeight
//            );
...
////            Log.i(lono_scanView.LOG_TAG, "bitmap:"+bitmap.getWidth()+","+bitmap.getHeight());
//
//            try {
//                if (!lono_scanView.exit) {
//                    result = lono_scanView.qrCodeReader.decode(bitmap, hintsRef.get());
////                    Log.i(lono_scanView.LOG_TAG, "result:"+result.getText());
//                }
//            } catch (FormatException e) {
//                Log.i(lono_scanView.LOG_TAG, "FormatException:" + e.getMessage());
//            } catch (ChecksumException e) {
//                Log.i(lono_scanView.LOG_TAG, "ChecksumException:" + e.getMessage());
//            } catch (NotFoundException e) {
////                return null;
//            } finally {
//                lono_scanView.qrCodeReader.reset();
//            }
//            return result;
//        }
//
...
//            final lono_scanView lono_scanView = viewRef.get();
//
//            if (lono_scanView!=null && result!=null && lono_scanView.captureListener!=null) {
//                lono_scanView.exit = true;
//                lono_scanView.captureListener.onCapture(result.getText());
////                lono_scanView.pause();
//                Vibrator myVib = (Vibrator) lono_scanView.context.getSystemService(VIBRATOR_SERVICE);
//                if (myVib != null) {
//                    myVib.vibrate(50);
//                }
//            }
